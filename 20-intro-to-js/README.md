...
document.addEventListener("click",function(event) {
  ...
  div.innerHTML = '<iframe width="560" height="315" src="https://www.youtube.com/embed/I73sP93-0xA?autoplay=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
...
### PARKING LOT
- how to get the reference point for arrays 
...
- numbers
- booleans
- same base data types 
- dot notation (objects)


## Diff
- pass by reference vs pass by value 
- only one kind of number in JS
- ones called obj and ones called hash but same data structure generally
- triple equals vs double equals
- arrays are objects in JS 
- using keywords to define variables 
- no implicit return 
- undefined/null == nil
- different truthy and falsey behavior in JS (falsey ==> 0, "", undefined, null, false)
- brackets and semicolons 
- JS is multiparadigm: functional and object oriented. Ruby is POOP 
